...
<div align="center">* *Figure showing the correlation table found in this project between NO2 levels and weather variables in Sheffield*
<div align="left">* **Predictive power of weather data:** Weather data can predict NO2 levels in Sheffield fairly well. The multilinear regression model had an adjusted R squared value of 0.62 and relative prediction error of 29.1%. The random forest model had an OOB R squared value of 0.67 and relative prediction error of 27.7%.
